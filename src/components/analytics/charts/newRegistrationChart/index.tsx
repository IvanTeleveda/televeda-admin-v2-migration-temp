...
export const NewRegistrationsChart: React.FC<{
    ...
    passedData
        ...
        const config = useMemo(() => {
            let configData: RegistrationAnalyticsQuery[] = data?.data.data || [];
            ...
            if(hideZeroValues) {
                configData = configData.filter(data => data.user_count > 0)
            }
                ...
                xAxis: {
                    label: {
                        formatter: (value: string) => {
                            return getDateFormat(value, groupByFilter);
                        }
                    },
                    line: null,
                },
            ...
            return config;
        }, [data, mode, hideZeroValues, isLoading]);
