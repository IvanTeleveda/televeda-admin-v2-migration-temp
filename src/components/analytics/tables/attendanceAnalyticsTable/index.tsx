...
import { Table, Typography, Space, Tooltip, Card, Row, Col, Statistic, Form, Select } from "antd";
import { useCustom } from "@refinedev/core";
import { InfoCircleOutlined, CalendarOutlined, TrophyOutlined, BarChartOutlined } from '@ant-design/icons';
...
type ViewMode = 'all' | 'selected' | 'other';
